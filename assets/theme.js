  ...
  theme.CartForm = (function() {
    ...
    CartForm.prototype = Object.assign({}, CartForm.prototype, {
      ...
      cartMarkup: function(html) {
        ...
        // console.log("items is" + JSON.stringify(items), markup);
        var count = parseInt(items.dataset.count);
        // var subtotal = items.dataset.cartSubtotal;
        // var subtotal = cart.original_total_price;
        var savings = items.dataset.cartSavings;
        
        var $carousel = $('.cart-recommendations .new-grid');
        ...
        $.getJSON('/cart.js').then(
          function(cart) {
            console.log("cart data is " + cart.original_total_price );
            subtotal = cart.original_total_price;
            
            $(".shipping-wrapper").addClass("hidden");
    //         $(".shipping-wrapper .top-wrapper p").addClass("hidden");
            $(".shipping-wrapper .top-wrapper .item-wrapper").addClass("hidden");
            $(".shipping-wrapper .bottom-wrapper p").addClass("hidden");
            $(".cart__footer .discount-wrapper").addClass("hidden");
            $(".cart__footer .discounted-price").addClass("hidden");
            $(".custom-cart__item--discount .discount-wrapper .discount-amount").html("");
            
            //getting the free shipping, first tier and second tier value
            var free_shipping_value = parseInt($(".shipping-wrapper .first-offer").data("value"))*100;
            var first_tier_value = parseInt($(".shipping-wrapper .sec-offer").data("value"))*100;
            var second_tier_value = parseInt($(".shipping-wrapper .third-offer").data("value"))*100;
            var first_discount_code = $(".cart__scrollable .custom-cart__item--discount").data("off_first");
            var second_discount_code = $(".cart__scrollable .custom-cart__item--discount").data("off_second");
            var first_discount_off = $(".shipping-wrapper .sec-offer").data("off");
            var second_discount_off = $(".shipping-wrapper .third-offer").data("off");
            console.log(first_discount_off, second_discount_off);
            
            if ( subtotal < free_shipping_value ){
              var differ_value = free_shipping_value - subtotal;
              $(".shipping-wrapper").removeClass("hidden");
              $(".spend-more").removeClass("hidden");
              $(".spend-more .remaining").html( theme.Currency.formatMoney(differ_value, theme.settings.moneyFormat) );
              $(".myProgress").removeClass("hidden");
              $(".myProgress .myBar").css("width", "25%");
              
              $(".ajax-announcement-wrapper").removeClass("hidden");
              //discount portion          
              $(".cart__footer .discounted-price").removeClass("hidden");
              $(".discounted-price span").html( "--" );
            //shipping price portion
              $(".shipping-price").html( theme.Currency.formatMoney(695, theme.settings.moneyFormat) );
              //total price portion
    //           var total_price = parseInt(subtotal) + 695;
    //           $(".total-price").html( theme.Currency.formatMoney(total_price, theme.settings.moneyFormat) );
            }else if ( subtotal >= free_shipping_value && subtotal < first_tier_value ){
              var differ_value = first_tier_value - subtotal;
              $(".shipping-wrapper").removeClass("hidden");
              $(".first-offer").removeClass("hidden");
              $(".first-offer-remaining").html( theme.Currency.formatMoney(differ_value, theme.settings.moneyFormat) );
              $(".myProgress").removeClass("hidden");
              $(".myProgress .myBar").css("width", "50%");
              ...
              $(".discounted-price span").html( "--" );
              //shipping price portion
              $(".shipping-price").html("Free U.S Shipping");
              //total price portion
    //           var total_price = parseInt(subtotal) + 695;
    //           $(".total-price").html( theme.Currency.formatMoney(total_price, theme.settings.moneyFormat) );
            }else if ( subtotal >= first_tier_value && subtotal < second_tier_value ){          
              var differ_value = second_tier_value - subtotal;
              $(".shipping-wrapper").removeClass("hidden");
              $(".sec-offer").removeClass("hidden");
              $(".sec-offer-remaining").html( theme.Currency.formatMoney(differ_value, theme.settings.moneyFormat) );
              $(".myProgress").removeClass("hidden");
              $(".myProgress .myBar").css("width", "75%");
              
              $(".ajax-announcement-wrapper").removeClass("hidden");
            //discount portion
              $(".cart__footer .discount-wrapper").removeClass("hidden");
              $(".cart__footer .discounted-price").removeClass("hidden");
              $(".custom-cart__item--discount .discount-wrapper").removeClass("hidden");
              $(".custom-cart__item--discount .discount-wrapper .discount-amount").html(first_discount_off);
    //           $(".discounted-price span").html( theme.Currency.formatMoney(subtotal*0.1, theme.settings.moneyFormat) );
              $(".discounted-price span").html(first_discount_code);
              //shipping price portion
              $(".shipping-price").html("Free U.S Shipping");
              //total price portion
    //           $(".total-price").html( theme.Currency.formatMoney(subtotal*0.9, theme.settings.moneyFormat) );
            }else if ( subtotal >= second_tier_value ){
              $(".shipping-wrapper").removeClass("hidden");
              $(".third-offer").removeClass("hidden");
              $(".myProgress").removeClass("hidden");
              $(".myProgress .myBar").css("width", "100%");
              ...
              $(".cart__footer .discounted-price").removeClass("hidden");
              $(".custom-cart__item--discount .discount-wrapper").removeClass("hidden");
              $(".custom-cart__item--discount .discount-wrapper .discount-amount").html(second_discount_off);
    //           $(".discounted-price span").html( theme.Currency.formatMoney(subtotal*0.15, theme.settings.moneyFormat) );
              $(".discounted-price span").html(second_discount_code);
              //shipping price portion
              $(".shipping-price").html("Free U.S Shipping");
              //total price portion
    //           $(".total-price").html( theme.Currency.formatMoney(subtotal*0.85, theme.settings.moneyFormat) );
            }
            
            if ( subtotal == 0 ){
              $(".shipping-wrapper").addClass("hidden");
              $(".ajax-announcement-wrapper").addClass("hidden");
              $(".myProgress .myBar").css("width", "0%");
            }
